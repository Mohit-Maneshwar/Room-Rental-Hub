        ...
        <section class='flex flex-col gap-[6rem]'>
            <section>
                <div class='flex flex-col gap-[3rem]'>
                    <h1 class='w-full text-center text-[7rem] uppercase'>Easily view your room</h1>
                    <h3 class='w-full text-center text-[3rem]'>Quickly browse and view rooms with ease on Room Rental Hub.</h3>
                    <div class='flex justify-center items-center'>
                        <p class='w-[70%] text-center text-[1.3rem]'>Effortlessly explore rooms with clear images and virtual tours on Room Rental Hub. Find your ideal space quickly and conveniently from anywhere.</p>
                    </div>
                </div>
            </section>
    <hr>
